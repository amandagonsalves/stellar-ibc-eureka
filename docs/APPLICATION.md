...
> [DRAFT NOTE: (1) a letter/note of support or intent from an IBC-ecosystem partner (Noble, an Osmosis-aligned team, a relayer operator) or from a Cardano Foundation contact; (2) a named Stellar anchor or wallet interested in IBC-bridged liquidity; (3) interest from Stellar Discord / SCF community; (4) any relayer operators willing to run the Stellar endpoint. Quote specific commitments. Even one named LOI dramatically outperforms generic claims.]
...
- *Estimated completion:* 9 weeks after approval.
- *Budget:* $20,000.
...
- *Budget:* $18,000. [DRAFT NOTE: This deliverable depends on Cardano-side testnet readiness/coordination. If that's uncertain, demote it to a T2 "stretch" or a post-award roadmap item and reallocate to hardening.]
...
- *Estimated completion:* 18 weeks after approval.
...
- *Estimated completion:* 21 weeks after approval.
- *Budget:* $18,000.
...
**Amanda Gonsalves** — Rust / Blockchain engineer (lead) · [GitHub](https://github.com/amandagonsalves) · [LinkedIn](#)

**Collaboration:** This work is being built in collaboration with the Cardano Foundation team.
